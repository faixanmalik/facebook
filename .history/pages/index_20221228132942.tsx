      ...
      <div className="container flex-col md:flex-row md:mt-44 mx-auto">
        ...
        <div className="right h-1/3 w-96 rounded-lg md:bg-white mx-auto relative shadow-xl">
            <div className="container flex flex-col p-2">
                ...
                <input className="p-2 bg-gray-200 border border-1 border-grey-300 text-sm rounded-md outline-blue-300" type="text" placeholder="Email address or phone number"/>
