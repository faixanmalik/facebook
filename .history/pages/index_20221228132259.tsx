      ...
      <div className="container flex-col md:flex-row md:mt-44 mx-auto">
        ...
        <div className="left  md:ml-28 md:w-1/3">
            <div className='flex container bg-yellow-100 bg-opacity-60 space-x-2 p-2'>
              ...
              <h1 className='text-blue-900 font-sans opacity-100 text-sm font-normal mt-1'>Get Facebook for Android and browse faster.</h1>
            </div>
            <img className="mx-auto mt-7 w-28 md:w-80" src="https://static.xx.fbcdn.net/rsrc.php/y8/r/dF5SId3UHWd.svg" alt=""/>
