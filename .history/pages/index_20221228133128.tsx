...
export default function Home() {
  ...
  <main>
      ...
      <div className="container flex-col md:flex-row md:mt-44 mx-auto">
        ...
        {/* Right Page */}
        <div className="right h-1/3 w-96 rounded-lg md:bg-white mx-auto relative shadow-xl">
            <div className="container flex flex-col p-2">


                <input className="p-3 text-black bg-gray-100 border border-1 border-grey-300 text-sm rounded-md outline-blue-300" type="text" placeholder="Mobile number or email address"/>
                <input className="p-3 text-black bg-gray-100 mt-2  border border-1 border-grey-300 text-sm rounded-md outline-blue-300" type="password" placeholder="Password"/>
