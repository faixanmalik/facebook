  ...
  <main>
      ...
      <div className="container flex-col md:flex-row md:mt-44 mx-auto">
        ...
        <div className="left  md:ml-28 md:w-1/3">
            <div className='flex container bg-yellow-50 space-x-2 p-2'>
              <img className='h-8 pl-2 rounded-t-md object-bottom' src="bgfb.png" alt="" />
              <h1 className='text-blue-800 opacity-100 text-sm font-semibold mt-1'>Get Facebook for Android and browse faster.</h1>
            </div>
