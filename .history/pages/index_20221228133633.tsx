      ...
      <div className="container flex-col md:flex-row md:mt-44 mx-auto">
        ...
        <div className="left  md:ml-28 md:w-1/3">
            <div className='flex container bg-yellow-100 bg-opacity-60 space-x-2 p-2'>
              ...
              <h1 className='text-blue-800 font-sans my-auto text-sm font-normal mt-1'>Get Facebook for Android and browse faster.</h1>
            </div>
        ...
        <div className="right mt-2 h-1/3 rounded-lg md:bg-white mx-auto relative shadow-xl">
            <div className="container flex flex-col px-4">
                ...
                <input className="px-2 py-3 text-black bg-gray-100 border border-1 border-gray-300 text-sm rounded-sm outline-1 outline-orange-300" type="text" placeholder="Mobile number or email address"/>
                <input className="px-2 py-3 text-black bg-gray-100 mt-2  border border-1 border-gray-300 text-sm rounded-sm outline-1 outline-orange-300" type="password" placeholder="Password"/>
