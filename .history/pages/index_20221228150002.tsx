      ...
      <div className="container flex flex-col md:flex-row md:mt-44 mx-auto">
        ...
        <div className="right mt-2 w-full md:pt-5 md:w-8/12 md:-mt-10 rounded-lg md:bg-white mx-auto md:ml-9 relative">
            <div className="container flex flex-col px-4">
                ...
                <input className="px-3 h-11 md:h-12 placeholder:text-gray-600 text-black bg-gray-100 md:bg-white border border-1 border-gray-300 text-sm rounded-sm outline-1 outline-orange-300" type="text" placeholder="Mobile number or email address"/>
                <input className="px-3 h-11 md:h-12 placeholder:text-gray-600 text-black bg-gray-100 md:bg-white mt-2  border border-1 border-gray-300 text-sm rounded-sm outline-1 outline-orange-300" type="password" placeholder="Password"/>
