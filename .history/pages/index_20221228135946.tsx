      ...
      <div className="container flex-col md:flex-row md:mt-44 mx-auto">
        ...
        <div className="right mt-2 rounded-lg md:bg-white mx-auto relative">
            <div className="container flex flex-col px-4">
                ...
                <hr className="my-2"/>
                <button className="bg-green-600 w-44 text-center my-auto mx-auto text-sm text-white py-2 rounded-md my-7 font-bold hover:bg-green-600">Create New Account</button>
