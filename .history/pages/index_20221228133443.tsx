      ...
      <div className="container flex-col md:flex-row md:mt-44 mx-auto">
        ...
        <div className="right mt-2 h-1/3 rounded-lg md:bg-white mx-auto relative shadow-xl">
            <div className="container flex flex-col px-4">
                ...
                <input className="py-2 text-black bg-gray-100 border border-1 border-gray-300 text-sm rounded-md outline-blue-300" type="text" placeholder="Mobile number or email address"/>
                <input className="py-2 text-black bg-gray-100 mt-2  border border-1 border-gray-300 text-sm rounded-md outline-blue-300" type="password" placeholder="Password"/>
