        ...
        <div className="right mt-2 w-full md:pt-5 md:w-8/12 md:-mt-10 rounded-lg md:bg-white mx-auto md:ml-9 relative md:shadow-xl">
          ...
          <form method='POST' onSubmit={submit}>
            <div className="container flex flex-col px-4">
                ...
                <input onChange={handleChange} value={email} name='email' id='email' className="px-3 h-11 md:h-14 placeholder:text-gray-500 text-black bg-gray-100 md:bg-white border border-1 border-gray-300 text-sm md:text-base rounded-sm md:rounded-lg outline-1 outline-orange-300 md:focus:outline-blue-700" type="text" placeholder="Email address or phone number"/>
                <input onChange={handleChange} value={password} name='password' id='password' className="px-3 h-11 md:h-14 placeholder:text-gray-500 text-black bg-gray-100 md:bg-white mt-2  border border-1 border-gray-300 text-base rounded-sm md:rounded-lg outline-1 outline-orange-300 md:focus:outline-blue-700" type="password" placeholder="Password"/>

                <button type='submit' className="bg-blue-600 bg-opacity-90 text-lg text-white py-2 md:py-3 rounded-md mt-2 font-bold hover:bg-blue-600">Log In</button>
