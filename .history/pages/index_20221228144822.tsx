      ...
      <div className="container flex flex-col md:flex-row md:mt-44 mx-auto">
        ...
        <div className="left md:ml-28 md:w-1/2">
          ...
          <div className='visible md:hidden'>
            ...
            <img className="mx-auto md:mx-0 leading-3 mt-2 md:mt-0 w-28 md:w-72" src="https://static.xx.fbcdn.net/rsrc.php/y8/r/dF5SId3UHWd.svg" alt=""/>
            <div className=''>
              <p className="text-sm md:text-3xl leading-3 md:ml-8 md:w-full">Facebook helps you connect and share with the people in your life.</p>
            </div>
        ...
        <div className="right mt-2 w-full md:w-9/12  rounded-lg md:bg-white mx-auto relative">
