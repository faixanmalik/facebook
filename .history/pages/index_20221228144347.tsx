      ...
      <div className="container flex flex-col md:flex-row md:mt-44 mx-auto">
        ...
        <div className="left md:ml-28 md:w-1/3">
          ...
          <div className='visible md:hidden'>
            ...
            <img className="mx-auto md:mx-0 mt-2 md:mt-0 w-28 md:w-80" src="https://static.xx.fbcdn.net/rsrc.php/y8/r/dF5SId3UHWd.svg" alt=""/>
            <div className=''>
        ...
        {/* Right Page */}
        <div className="right mt-2 w-full md:w-96 rounded-lg md:bg-white mx-auto relative">
