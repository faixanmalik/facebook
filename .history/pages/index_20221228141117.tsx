  ...
  <main>
      ...
      <div className="container flex-col md:flex-row md:mt-44 mx-auto">
        ...
        <div className="right mt-2 rounded-lg md:bg-white mx-auto relative">
          ...
          {/* languages */}
          <div className='container w-9/12 mx-auto text-xs font-bold  flex space-x-20'>
              <div className='w-1/3 space-y-2 text-slate-500 text-center border-2 border-red-700'>
                <h1>English (UK)</h1>
                <h1>English (US)</h1>
              </div>
              <div className='w-1/3 space-y-2 text-gray-500 text-center border-2 border-red-700'>
                <h1>Urdu</h1>
                <h1>Hindi</h1>
              </div>
          </div>
