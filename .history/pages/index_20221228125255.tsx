  ...
  <main>
      ...
      <div className="container flex-col md:flex md:mt-44 mx-auto">
        ...
        <div className="left  md:ml-28 md:w-1/3">
            ...
            <img className="mx-auto w-32 md:w-80" src="https://static.xx.fbcdn.net/rsrc.php/y8/r/dF5SId3UHWd.svg" alt=""/>
            <p className=" text-sm  md:text-3xl md:-mt-4 md:ml-8 md:w-full">Facebook helps you connect and share with the people in your life.</p>
            <p className=" text-sm  md:text-3xl md:-mt-4 md:ml-8 md:w-full">Facebook helps you connect and share with the people in your life.</p>
